...
recovery substantially substitutes for domain-specific pretraining. Recent surgical vision--language work reports that a linear probe on frozen
features can come within a few F1 points of specialised temporal architectures,
which retain only a modest average advantage despite far greater complexity.
\textbf{[VERIFY these figures against SurgLaVi, arXiv:2509.10555, before
citing]}
