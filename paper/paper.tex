...
\newblock {EndoViT}: pretraining vision transformers on a large collection of
  endoscopic images.
\newblock \emph{Int.\ J.\ Computer Assisted Radiology and Surgery}, 2024.
...
\bibitem[Jaspers et~al.(2025)]{jaspers2025surgenetxl}
T.~J.~M. Jaspers et~al.
\newblock Scaling up self-supervised learning for improved surgical foundation
  models.
\newblock \emph{Medical Image Analysis}, 2025.
\textbf{[VERIFY full author list, volume, pages]}
...
\bibitem[Liu et~al.(2025)]{liu2025lovit}
Y.~Liu, M.~Boels, L.~C. Garcia-Peraza-Herrera, et~al.
\newblock {LoViT}: Long video transformer for surgical phase recognition.
\newblock \emph{Medical Image Analysis}, 2025.
\textbf{[VERIFY year, volume]}
...
\newblock {BiomedCLIP}: A multimodal biomedical foundation model pretrained
  from fifteen million scientific image-text pairs.
\newblock \emph{arXiv:2303.00915}, 2023.

\bibitem[{ZEN authors}(2026)]{zen2026}
{ZEN authors}.
